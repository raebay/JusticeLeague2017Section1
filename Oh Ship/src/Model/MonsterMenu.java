...
public class MonsterMenu {
	...
	public MonsterMenu()
	{
		...
		monsterList.add(new Monster(IDs[0], name[0], description, surrender, new CharacterSt(3,1,5,3)));
		...
		monsterList.add(new Monster(IDs[1], name[1], description, surrender, new CharacterSt(4,2,6,3)));
		...
		monsterList.add(new Monster(IDs[2], name[2], description, surrender, new CharacterSt(5,3,7,3)));
		...
		surrender = "You make them aware of your\n" + 
				...
				"immediately.";
		monsterList.add(new Monster(IDs[3], name[3], description, surrender, new CharacterSt(6,4,8,3)));
		
		description = "When the storage room is opened, a pirate jumps out of nowhere and attacks.";
		surrender = "You are defeated";
		monsterList.add(new Monster(IDs[4], name[4], description, surrender, new CharacterSt(7,5,9,3)));
		...
		surrender = "You announce your presence while\n" + 
				...
				"ship.";
		monsterList.add(new Monster(IDs[6], name[6], description, surrender, new CharacterSt(9,7,11,3)));
		...
		surrender = "You are able to push one over the\n" + 
				...
				"the second";
		monsterList.add(new Monster(IDs[7], name[7], description, surrender, new CharacterSt(10,8,12,3)));
		...
		surrender = "You are defeated";
		monsterList.add(new Monster(IDs[8], name[8], description, surrender, new CharacterSt(12,10,15,3)));
	}
